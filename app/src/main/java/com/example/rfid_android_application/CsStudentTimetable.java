...
public class CsStudentTimetable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cs_students_timetable);

        tableLayout = findViewById(R.id.CsStudentTimetable);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                TableRow tableRow = new TableRow(CsStudentTimetable.this);

                                TextView dayView = new TextView(CsStudentTimetable.this);
                                ...
                                for (String timeSlot : timeSlots) {
                                    TextView subjectView = new TextView(CsStudentTimetable.this);
                            ...
                            e.printStackTrace();
                            Toast.makeText(CsStudentTimetable.this, "Error parsing data.", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CsStudentTimetable.this, "Error fetching data.", Toast.LENGTH_SHORT).show();
