...
public class GeologyStudentTimetable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geology_student_timetable);

        tableLayout = findViewById(R.id.GeologyStudentTimetable);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                TableRow tableRow = new TableRow(GeologyStudentTimetable.this);

                                TextView dayView = new TextView(GeologyStudentTimetable.this);
                                ...
                                for (String timeSlot : timeSlots) {
                                    TextView subjectView = new TextView(GeologyStudentTimetable.this);
                            ...
                            e.printStackTrace();
                            Toast.makeText(GeologyStudentTimetable.this, "Error parsing data.", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(GeologyStudentTimetable.this, "Error fetching data.", Toast.LENGTH_SHORT).show();
